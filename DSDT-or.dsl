 ...
 *
 * Disassembly of iASLdV9H8o.aml, Sat Mar 28 22:00:02 2015
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00014092 (82066)
 ...
 */
DefinitionBlock ("iASLdV9H8o.aml", "DSDT", 1, "_ASUS_", "Notebook", 0x00000000)
{
    External (PDC7)
    External (PDC6)
    External (PDC5)
        ...
        Device (PCI0)
        {
            ...
            Device (GFX0)
            {
                ...
                Method (HINI, 0, NotSerialized)
                {
                    ...
                    If (LNot (LOr (\_OSI ("Windows 2006"), \_OSI ("Windows 2009"))))
                    {
                        \SGPL (0x10, 0x01, 0x00)
                        Sleep (0x0A)
                        \SGPL (0x24, 0x01, 0x01)
                ...
                Method (_DSM, 4, NotSerialized)
                {
                            ...
                            }))
                    {
                        ...
                        Add (ShiftLeft (DerefOf (Index (Arg3, 0x02)), 0x10), Local0, 
                            Local0)
                        Add (ShiftLeft (DerefOf (Index (Arg3, 0x01)), 0x08), Local0, 
                            Local0)
                        Add (ShiftLeft (DerefOf (Index (Arg3, 0x00)), 0x00), Local0, 
                            Local0)
                        Name (_T_0, Zero)
                                ...
                                Else
                                {
                                    If (LEqual (_T_0, 0x03))
                                    {
                                        ...
                                        Else
                                        {
                                            ...
                                            Else
                                            {
                                                Return (\_SB.PCI0.PEG1.GFX0.DSTA ())
                                            }
                                        }
                                    ...
                                    Else
                                    {
                                        If (LEqual (_T_0, 0x04))
                                        {
                                            ...
                                            Name (HBDP, 0x00)
                                            CreateField (NFBU, 0x00, 0x0C, BDRF)
                                            CreateField (NFBU, 0x0C, 0x01, BDOF)
                                            CreateField (NFBU, 0x0D, 0x02, PSRF)
                                            CreateField (NFBU, 0x0F, 0x01, PSOF)
                                            CreateField (NFBU, 0x10, 0x04, PTVF)
                                            CreateField (NFBU, 0x14, 0x01, PTVO)
                                            CreateField (NFBU, 0x15, 0x05, TVFF)
                                            CreateField (NFBU, 0x1A, 0x01, TVOF)
                                            Name (_T_1, Zero)
                                            Store (ToInteger (HBDP), _T_1)
                                            If (LEqual (_T_1, 0x07))
                                            {
                                                Store (0x10, Index (NFBU, 0x00))
                                            }
                                            Else
                                            {
                                                If (LEqual (_T_1, 0x0B))
                                                {
                                                    Store (0x11, Index (NFBU, 0x00))
                                                }
                                                Else
                                                {
                                                    If (LEqual (_T_1, 0x0D))
                                                    {
                                                        Store (0x12, Index (NFBU, 0x00))
                                                    }
                                                    Else
                                                    {
                                                        If (LEqual (_T_1, 0x0E))
                                                        {
                                                            Store (0x14, Index (NFBU, 0x00))
                                                        }
                                                        Else
                                                        {
                                                            If (LEqual (_T_1, 0x0F))
                                                            {
                                                                Store (0x18, Index (NFBU, 0x00))
                                                            }
                                                            Else
                                                            {
                                                                Store (HBDP, Index (NFBU, 0x00))
                                                            }
                                                        }
                                                    }
                                                }
    ...
    Scope (\_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            {
                Store (Arg0, \_SB.PCI0.SBRG.EC0.HKEN)
                Return (0x00)
            }
    ...
    Scope (\_SB.ATKD)
    {
        ...
        Method (SOCK, 2, NotSerialized)
        {
            ...
            If (LOr (LEqual (SAPS, 0x00), LEqual (SAPS, 0x01)))
            {
                ...
                \_SB.PCI0.SBRG.EC0.WKTM (0x02)
                \_SB.PCI0.SBRG.EC0.WKFG (0x01)
                Store (\_SB.PCI0.SBRG.EC0.RRAM (0x0385), Local0)
                Or (Local0, 0x01, Local0)
                \_SB.PCI0.SBRG.EC0.WRAM (0x0385, Local0)
            }
            Else
            {
                If (LNotEqual (0x04, Zero))
    ...
    Scope (\_SB.PCI0.SBRG.EC0)
    {
        ...
        Method (EC0S, 1, NotSerialized)
        {
            ...
            If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
            {
                ...
                If (Local1)
                {
                    \_SB.PCI0.SBRG.EC0.WRAM (0x044B, 0x00)
                    And (Local0, 0xFA, Local1)
                    \_SB.PCI0.SBRG.EC0.WRAM (0x0449, Local1)
                }
            }
    ...
    Scope (\_SB.PCI0.PEG1)
    {
        Method (_STA, 0, Serialized)
        {
            If (LNotEqual (\_SB.PCI0.PEG1.SVID, 0xFFFFFFFF))
            {
                Store (0x00, \_SB.PCI0.PEG1.NHDA)
                Sleep (0x32)
            }
    ...
    Scope (\_SB.PCI0.PEG1.GFX0)
    {
        ...
        Method (_ON, 0, NotSerialized)
        {
            ...
            \_SB.PCI0.SBRG.EC0.WRAM (0x052E, 0x00)
            \_SB.PCI0.SBRG.EC0.WRAM (0x052F, 0x00)
            \_SB.PCI0.SBRG.EC0.WRAM (0x052B, 0x9E)
            \_SB.PCI0.SBRG.EC0.WRAM (0x0520, 0x96)
            Store (\_SB.PCI0.SBRG.EC0.RRAM (0x0521), Local0)
            And (Local0, 0xCF, Local0)
            Or (Local0, 0x20, Local0)
            \_SB.PCI0.SBRG.EC0.WRAM (0x0521, Local0)
        ...
        Method (_OFF, 0, NotSerialized)
        {
            ...
            \_SB.PCI0.GFX0.SAVO ()
            Store (0x00, ASPM)
            Store (\_SB.BDFR (RE19, 0x00, 0x00, 0x34), Local1)
            Store (\_SB.RBPE (Local1), Local0)
            Store (0x01, Local2)
            While (Local2)
            {
                If (LNotEqual (Local0, 0x00))
                {
                    Store (\_SB.BDFR (RE19, 0x00, 0x00, Local0), Local1)
                    Store (\_SB.RBPE (Local1), Local0)
            ...
            Method (WMMX, 3, NotSerialized)
            {
                If (LGreaterEqual (SizeOf (Arg2), 0x04))
                {
                    ...
                    If (LEqual (FUNC, 0x444F445F))
                    {
                        ...
                        Else
                        {
                            Return (\_SB.PCI0.PEG1.GFX0._DOD ())
                        }
                    }
                    Else
                    {
                        If (LEqual (FUNC, 0x5343445F))
                        {
                            If (LGreaterEqual (SizeOf (Arg2), 0x08))
                            {
                                If (LEqual (ARGS, 0x0100))
                                {
                                    ...
                                    Else
                                    {
                                        Return (\_SB.PCI0.PEG1.GFX0.CRTD._DCS ())
                                    }
                                }
                                Else
                                {
                                    ...
                                    Else
                                    {
                                        If (LEqual (ARGS, 0x7330))
                                        {
                                            ...
                                            Else
                                            {
                                                Return (\_SB.PCI0.PEG1.GFX0.HDMI._DCS ())
                                            }
                                        }
                                    }
                                }
                        ...
                        Else
                        {
                            If (LEqual (FUNC, 0x534F525F))
                            {
                                If (LGreaterEqual (SizeOf (Arg2), 0x08))
                                {
                                    If (LNotEqual (Arg1, 0x10))
                                    {
                                        Return (\_SB.PCI0.PEG1.GFX0._ROM (ARGS, XARG))
                                    }
                                }
                            }
                            Else
